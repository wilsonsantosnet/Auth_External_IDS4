...
namespace IdentityServer4.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        private readonly ExternalProviderAuth _externalProviderAuth;
        ...
        public AccountController(
            ...
            ExternalProviderAuth externalProviderAuth)
        {
            ...
            _externalProviderAuth = externalProviderAuth;
        }
        ...
        /// <summary>
        /// processing of external authentication and show External Page
        /// </summary>
        [HttpGet]
        public async Task<IActionResult> ExternalLogin(string provider, string returnUrl)
        {
            return await _externalProviderAuth.Login(Url, provider, returnUrl);
        }


        /// <summary>
        ///  external authentication processing and checks if the user exists by email
        /// </summary>
        [HttpGet]
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl)
        {

            return await this._externalProviderAuth.Callback(returnUrl, (email) =>
            {
                var user = this._usersServices.AuthByExternalLogin(email);
                if (user.IsNull())
                    throw new Exception("User e-mail not found here!");
                return user;
            });
